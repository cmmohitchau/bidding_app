  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200">
      <div className="bg-white shadow-2xl rounded-2xl w-full max-w-md px-8 py-10">
        <h1 className="text-2xl text-gray-500 font-bold text-center mb-6">Welcome Back</h1>
        ...
        <div className="mb-4">
          ...
          <input
            className="mt-1 px-3 py-2 w-full border rounded-xl text-gray-500 outline-none focus:ring-2 focus:ring-green-400"
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="mt-1 px-3 py-2 w-full text-gray-500 border rounded-xl outline-none focus:ring-2 focus:ring-green-400"
            type="password"
            placeholder="••••••••"
          />
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 border py-3 rounded-xl text-gray-500 hover:bg-gray-700 transition-all"
        >
          <Github size={18} />
